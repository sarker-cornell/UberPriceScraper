...
chromedriver = "C:/Users/vk24/Desktop/uber_local_scrape/chromedriver.exe"
...
def download(link):
    ...
    try:
        time.sleep(max((9-(time.time() - down_start_time)),0.1))
        for i in range(12):      
...
if __name__ == "__main__":
    ...
    for i in range(0,10):
        if (start_time + i*interval - time.time()) > 0:
            ...
            print("hahah ERROR ############# Loop number:"+str(i))
            rectup = (now, i, str(datetime.datetime.now()), None,None,None,None,None,None,None,None,None,None,"ERROR NO DATA LOOP JUMP")
            try:
